...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = timeTrackerProFirebaseUserStream()
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: FloatingNavbar(
        ...
        selectedItemColor: const Color(0xFF090A0A),
            ...
            customWidget: Column(
              ...
              children: [
                Icon(
                  ...
                  color:
                      currentIndex == 0 ? const Color(0xFF090A0A) : const Color(0x8A000000),
            ...
            customWidget: Column(
              ...
              children: [
                Icon(
                  ...
                  color:
                      currentIndex == 1 ? const Color(0xFF090A0A) : const Color(0x8A000000),
